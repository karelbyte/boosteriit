...
export default function IndustriesBannerFooter() {
  return (
    <div className="p-6 bg-[#ECF5FE] mt-14 py-2 px-12 md:flex-row sm:py-4 sm:px-10 lg:px-20 lg:py-20">
      <div className="flex flex-col md:flex-row justify-between">
        ...
        <div className="flex flex-col my-8 md:mt-2  md:ml-12 md:py-12 lg:p-6 justify-between w-full">
          ...
          <span className="text-[#161616] text-xl w-full lg:w-10/12 mb-6 font-light">
          ...
          <div className="flex justify-between mt-8">
            ...
            <button className="py-2 px-4 rounded mr-2 border border-[#00B8EC] text-[#00B8EC] hover:bg-[#007799] hover:text-white w-full ml-6">
              Agendar llamada
            </button>
          </div>
        </div>
